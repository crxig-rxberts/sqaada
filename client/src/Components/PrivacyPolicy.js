        ...
        <div className="container py-5">
            ...
            <div className="card shadow">
                <div className="card-body bg-light-opaque">
                    ...
                    <p>Welcome to ToDo App. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>

                    <h2 className="h4 mb-4 mt-5">2. Data We Collect</h2>
                    ...
                    <h2 className="h4 mb-4 mt-5">3. How We Use Your Data</h2>
                    ...
                    <h2 className="h4 mb-4 mt-5">4. Data Security</h2>
                    <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.</p>

                    <h2 className="h4 mb-4 mt-5">5. Your Legal Rights</h2>
                    ...
                    <h2 className="h4 mb-4 mt-5">6. Contact Us</h2>
